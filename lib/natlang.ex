...
defmodule Lstm do
  ...
  def backpropagation(l,[{:lstm,c,e,lr}|rest],[u|us],res) do
    l1 = backpropagation1(l,e,u,[])
  ...
  def backpropagation1(l,[[_,wh,_]|es],[[c1,h1,x1,f1,g1,i1,o1],[c2,h2,x2,f2,g2,i2,o2]|us],res) do
    ...
    backpropagation1(l1,es,[[c2,h2,x2,f2,g2,i2,o2]|us],[[wx1,wh1,b1]|res])
  end
